        ...
        <div>
            ...
            <Row gutter={16} style={{ marginBottom: "20px", marginTop: "50px" }}>
                <Col className="gutter-row" style={{ marginBottom: "10px" }} xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                    <div className='host-payment-card payment' style={{ border: "1px solid #00a991" }}>
                        <div className='progressbar'>
                            <Progress type="circle" percent={75} strokeColor="#00a991" />
                        </div>
                        <div className='total-payment'>

                            <h1 style={{ fontSize: "1.5rem", fontWeight: "300", marginTop: "15px", marginBottom: "15px" }}>Total Payments</h1>
                            <h3 style={{ fontSize: "1.5rem", letterSpacing: ".2rem", marginBottom: "15px", color: "#00a991" }}>$ 25,50,20.00</h3>
                        </div>
                    </div>

                </Col>
                <Col className="gutter-row" style={{ marginBottom: "10px" }} xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                    <div className='host-payment-card pending' style={{ border: "1px solid red" }}>
                        <div className='progressbar'>
                            <Progress type="circle" percent={22} strokeColor="red" />
                        </div>
                        <div className='total-payment'>

                            <h1 style={{ fontSize: "1.5rem", fontWeight: "300", marginTop: "15px", marginBottom: "15px" }}>Total Pendings</h1>
